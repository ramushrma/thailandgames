            ...
            <table id="example" class="table table-striped" style="width:100%">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{$item->availed_num}}</td>
                  <td>{{$item->created_at}}</td>
                  <td>
                    <a href="{{route('gift.delete', $item->id)}}" class="btn btn-danger btn-sm">
          ...
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" id="number_people" name="number_people" placeholder="Enter number of people">
              </div>
            </div>
          </div>
        </div>

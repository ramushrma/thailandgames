...
<body style="font-size: 12px;">
    <div id="app" data-v-app="" style="background-color:black;">
        ...
        <div data-v-a4c8bf60="" class="resgister__C" style="--f817f0ee: 'Roboto', 'Inter', sans-serif;"
            ...
            <div data-v-81ead1cb="" data-v-a4c8bf60="" class="navbar">
                <div data-v-81ead1cb="" class="navbar-fixed wc" style="background:black;;">
                    <div data-v-81ead1cb="" class="navbar__content" style="background-color:black">
                        <div data-v-81ead1cb="" class="navbar__content-left">
                            <i data-v-81ead1cb="" class="van-badge__wrapper van-icon van-icon-arrow-left"></i>
                        </div>
                        <div data-v-81ead1cb="" class="navbar__content-center" style="background-color:black;">
                            <!--<img src="https://root.nandigame.live/assets/nandi3.png" height="100%">-->
                            <h2 style="color : white; font-weight: bold; font-size: 20px;">Xgamblur</h2>
                        </div>
                        <div data-v-81ead1cb="" class="navbar__content-title"></div>
                    </div>
                   @if(session('success'))
                       <center> <h1 style="color: green; font-size:25px;">{{ session('success') }}</h1></center>
                        <script>
                            setTimeout(function(){
                                window.location.href = "https://xgamblur.com/";
                    ...
                    @endif
                    <div data-v-81ead1cb="" class="navbar__content-right" style="background-color:black;">
                        <div data-v-4eb25d27="" data-v-a4c8bf60="" style="background-color:#2a8ff3;">
                            <!---->
                            <form action="{{route('referral_code_register', $referrer_code)}}" method="post">
                                @csrf
                        </div>
                    </div>
                </div>
        ...
        <div data-v-a4c8bf60="" class="resgister__C-form" style="background-color: LightGray;">
                ...
                <div data-v-327ab6b4="" data-v-a4c8bf60="" class="register__container">
                    <div data-v-dba00bcf="" data-v-327ab6b4="" class="phoneInput__container">
                        <div data-v-dba00bcf="" class="phoneInput__container-label">
                            ...
                            <span data-v-dba00bcf="" style="color: black;">Phone number</span>
                        </div>
                        <div data-v-dba00bcf="" class="phoneInput__container-input">
                            <div data-v-183fb3f9="" data-v-dba00bcf="" style="background-color: white; color:grey"
                                class="dropdown">
                                <div data-v-183fb3f9="" class="dropdown__value">
                                    <span data-v-183fb3f9="" style="color: Gray;">+91</span>
                                    <i data-v-183fb3f9="" style="color: Gray;"
                                        class="van-badge__wrapper van-icon van-icon-arrow-down">
                                    </i>
                                </div>

                            </div>
                            <input data-v-dba00bcf="" type="number" style="background-color: white; color:grey"
                                id="mobileNumber" name="mobile" placeholder="Please enter the phone number" value="{{ old('mobile') }}"
                    ...
                    <div data-v-327ab6b4="" class="register__container-invitation">
                        <div data-v-327ab6b4="" class="register__container-invitation__label"><img data-v-327ab6b4=""
                                class="register__container-invitation__label-icon"
                                data-src="/assets/png/invitation-5285cf0f.png" src="/assets/png/invitation-5285cf0f.png"
                                lazy="loaded"><span data-v-327ab6b4="" style="color: black;">Email</span></div>
                        <div data-v-327ab6b4="" class="register__container-invitation__input">
                            <input data-v-327ab6b4="" name="email" required value="{{ old('email') }}" type="text"
                                placeholder="Please enter your email" style="background-color: white; color:grey"
                    ...
                    <div data-v-934f92c4="" data-v-327ab6b4="" class="passwordInput__container">
                        <div data-v-934f92c4="" class="passwordInput__container-label"><img data-v-934f92c4=""
                                ...
                                lazy="loaded"><span data-v-934f92c4="" style="color: black;">Set password</span></div>
                        <div data-v-934f92c4="" class="passwordInput__container-input"><input data-v-934f92c4=""
                                type="password" required placeholder="Set password" name="password" maxlength="15" value="{{ old('password') }}"
                                style="background-color: white; color:grey" autocomplete="new-password" required>

                            <img data-v-934f92c4="" src="/assets/png/eyeInvisible-821d9d16.png" class="eye">
                        </div>
                        @error('password')
                        <div class="alert alert-warning" style="color: red;">{{ $message }}</div>
                        @enderror
                    ...
                    <div data-v-934f92c4="" data-v-327ab6b4="" class="passwordInput__container">
                        <div data-v-934f92c4="" class="passwordInput__container-label"><img data-v-934f92c4=""
                                class="passwordInput__container-label__icon"
                                data-src="/assets/png/password-12e0a3fc.png" src="/assets/png/password-12e0a3fc.png"
                                lazy="loaded"><span data-v-934f92c4="" style="color: black;">Confirm password</span>
                        </div>
                        <div data-v-934f92c4="" class="passwordInput__container-input">
                            <input data-v-934f92c4="" type="password" required name="confirm_password" value=""
                    ...
                    <div data-v-327ab6b4="" class="register__container-invitation">
                        <div data-v-327ab6b4="" class="register__container-invitation__label"><img data-v-327ab6b4=""
                                class="register__container-invitation__label-icon"
                                data-src="/assets/png/invitation-5285cf0f.png" src="/assets/png/invitation-5285cf0f.png"
                                lazy="loaded"><span data-v-327ab6b4="" style="color: black;">Invite code</span></div>
                        <div data-v-327ab6b4="" class="register__container-invitation__input">

                            <input data-v-327ab6b4="" name="referral_code" value="{{$referrer_code}}" type="text"
                                auto-complete="new-password" style="background-color: white; color:grey"
                                autocomplete="off" name="userNumber" placeholder="Please enter your email" disabled=""
                                maxlength="40" required>
                        </div>
                    </div>

                    <div data-v-327ab6b4="" class="register__container-remember">
                        <div data-v-327ab6b4="" role="checkbox" class="van-checkbox" tabindex="0" aria-checked="false">
                        </div>
                    </div>
                    <div data-v-327ab6b4="" class="register__container-button">
                        <button data-v-327ab6b4="" type="submit" style="background:black">Register</button><br>
                        <!--<a href="http://nandigame.live/" data-v-327ab6b4="" type="">login</a>-->

                        <a href="https://tswin.in/" style="
=======
...
<link rel="modulepreload" as="script" crossorigin="" href="/assets/js/index-74b8a99f.js">
	...
	<body style="font-size: 12px;" >	
		<div id="app" data-v-app="" style="background-color:#2a8ff3;">
			...
			<div data-v-a4c8bf60="" class="resgister__C" style="--f817f0ee: 'Roboto', 'Inter', sans-serif;" style="background-color:#2a8ff3;">
				<div data-v-81ead1cb="" data-v-a4c8bf60="" class="navbar">
					<div data-v-81ead1cb="" class="navbar-fixed wc" style="background: rgb(43, 50, 112);">
						<div data-v-81ead1cb="" class="navbar__content" style="background-color:#2a8ff3;">
							<div data-v-81ead1cb="" class="navbar__content-left">
								<i data-v-81ead1cb="" class="van-badge__wrapper van-icon van-icon-arrow-left"></i></div>
							<div data-v-81ead1cb="" class="navbar__content-center" style="background-color:#2a8ff3;">
								<!--<img src="https://root.nandigame.live/assets/nandi3.png" height="100%">-->
							...
							<div data-v-81ead1cb="" class="navbar__content-right" style="background-color:#2a8ff3;" >
								<div data-v-4eb25d27="" data-v-a4c8bf60="" style="background-color:#2a8ff3;"><!---->
		<form action="{{route('user_register',$ref_id->referral_code)}}" method="post">
		    @csrf
		</div>
		</div></div></div></div>		
					<div style="text-align:center; background-color:#2a8ff3;" >
						<img data-v-dba00bcf="" src="/assets/png/cellphone-35529171.png"  class="phoneInput__container-label__icon">
							<p style="color : white; font-weight: bold; font-size: 20px;">Register your phone</p>
						<hr>
					</div>
						...
						<div data-v-a4c8bf60="" class="tab-content activecontent">
							...
							<div data-v-327ab6b4="" data-v-a4c8bf60="" class="register__container">
								<div data-v-dba00bcf="" data-v-327ab6b4="" class="phoneInput__container">
									...
									<div data-v-dba00bcf="" class="phoneInput__container-input">
										<div data-v-183fb3f9="" data-v-dba00bcf="" style="background-color: white; color:grey" class="dropdown">
											<div data-v-183fb3f9="" class="dropdown__value">
												<span data-v-183fb3f9="" style="color: Gray;">+91</span>
												<i data-v-183fb3f9="" style="color: Gray;" class="van-badge__wrapper van-icon van-icon-arrow-down">
													</i>
											</div>
										
										</div>
										<input data-v-dba00bcf="" type="number" style="background-color: white; color:grey" id="mobileNumber" name="mobile" placeholder="Please enter the phone number" maxlength="10" required>
        ...
        @enderror
									...
									<div data-v-dba00bcf="" class="phoneInput__container-label">
										<img data-v-dba00bcf="" src="/assets/png/cellphone-35529171.png" class="phoneInput__container-label__icon">
										<span data-v-dba00bcf="" style="color: black;">OTP</span>
									</div>
									<div data-v-dba00bcf="" class="phoneInput__container-input">
										<div data-v-183fb3f9="" data-v-dba00bcf="" class="dropdown" style="background-color: green;">
											      <div data-v-183fb3f9="" class="dropdown__value" id="sendOtp">
            										<span data-v-183fb3f9 >Send</span>
        										  </div>
										</div>
										<input data-v-dba00bcf="" type="number" style="background-color: white; color:grey" name="otp" placeholder="Please enter the otp" maxlength="10" required>
     ...
     <script>
            ...
            xhrSend.onreadystatechange = function () {
                if (xhrSend.readyState === 4) {
                    if (xhrSend.status === 200) {
                        ...
                        // Automatically proceed to verify the OTP received
        ...
        function verifyOtp(mobileNumber, otp) {
            ...
            xhrVerify.send();
				...
				<div data-v-327ab6b4="" class="register__container-tips" style="display: none;"><span data-v-327ab6b4="">Entered twice the password does not match!</span></div><div data-v-327ab6b4="" class="register__container-invitation"><div data-v-327ab6b4="" class="register__container-invitation__label"><img data-v-327ab6b4="" class="register__container-invitation__label-icon" data-src="/assets/png/invitation-5285cf0f.png" src="/assets/png/invitation-5285cf0f.png" lazy="loaded"><span data-v-327ab6b4="" style="color: black;">Email</span></div><div data-v-327ab6b4="" class="register__container-invitation__input">
								<input data-v-327ab6b4="" name="email"  required value="" type="text"  placeholder="Please enter your email" style="background-color: white; color:grey" maxlength="40" required>    
		</div>
		@error('email')
            <div class="alert alert-warning" style="color: red;">{{ $message }}</div>
        @enderror
		...
		<div data-v-327ab6b4="" class="tip"><!----><!----></div><!----><div data-v-934f92c4="" data-v-327ab6b4="" class="passwordInput__container"><div data-v-934f92c4="" class="passwordInput__container-label"><img data-v-934f92c4="" class="passwordInput__container-label__icon" data-src="/assets/png/password-12e0a3fc.png" src="/assets/png/password-12e0a3fc.png" lazy="loaded"><span data-v-934f92c4="" style="color: black;">Set password</span></div><div data-v-934f92c4="" class="passwordInput__container-input"><input data-v-934f92c4="" type="password" required placeholder="Set password" name="password" maxlength="15" style="background-color: white; color:grey" autocomplete="new-password" required>
		
		<img data-v-934f92c4="" src="/assets/png/eyeInvisible-821d9d16.png" class="eye"></div>
		 @error('password')
            <div class="alert alert-warning"style="color: red;">{{ $message }}</div>
        @enderror
        </div><div data-v-327ab6b4="" class="register__container-tip" style="display: none;"><div data-v-327ab6b4="" class="tipbg"></div><span data-v-327ab6b4="">The password must be at least 8 digits and must contain letters + numbers</span></div><div data-v-934f92c4="" data-v-327ab6b4="" class="passwordInput__container"><div data-v-934f92c4="" class="passwordInput__container-label"><img data-v-934f92c4="" class="passwordInput__container-label__icon" data-src="/assets/png/password-12e0a3fc.png" src="/assets/png/password-12e0a3fc.png" lazy="loaded"><span data-v-934f92c4="" style="color: black;">Confirm password</span></div><div data-v-934f92c4="" class="passwordInput__container-input">
								<input data-v-934f92c4="" type="password" required name="password_confirmation" placeholder="Confirm password" maxlength="15" style="background-color: white; color:grey" autocomplete="new-password" required>
		...
		<img data-v-934f92c4="" src="/assets/png/eyeInvisible-821d9d16.png" class="eye"></div>
		 ...
		 @error('password_confirmation')  
            <div class="alert alert-warning" style="color: red;">{{ $message }}</div>
        @enderror
		</div><div data-v-327ab6b4="" class="register__container-tips" style="display: none;"><span data-v-327ab6b4="">Entered twice the password does not match!</span></div><div data-v-327ab6b4="" class="register__container-invitation"><div data-v-327ab6b4="" class="register__container-invitation__label"><img data-v-327ab6b4="" class="register__container-invitation__label-icon" data-src="/assets/png/invitation-5285cf0f.png" src="/assets/png/invitation-5285cf0f.png" lazy="loaded"><span data-v-327ab6b4="" style="color: black;">Invite code</span></div><div data-v-327ab6b4="" class="register__container-invitation__input">
								
								<input data-v-327ab6b4="" name="referral_code" value="{{$ref_id->referral_code}}" type="text" auto-complete="new-password" style="background-color: white; color:grey"
		autocomplete="off" name="userNumber" placeholder="Please enter your email" disabled="" maxlength="40" required>
		</div></div>

		<div data-v-327ab6b4="" class="register__container-remember"><div data-v-327ab6b4="" role="checkbox" class="van-checkbox" tabindex="0" aria-checked="false"></div></div><div data-v-327ab6b4="" class="register__container-button">
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        document.querySelectorAll(".passwordInput__container-input").forEach(function (container) {
            let input = container.querySelector("input");
            let toggleIcon = container.querySelector(".eye");
            ...
            toggleIcon.addEventListener("click", function () {
                if (input.type === "password") {
                    input.type = "text";
                    toggleIcon.src = "/assets/png/eye.jpg"; // 👁️ Replace with visible eye icon
                } else {
                    input.type = "password";
                    toggleIcon.src = "/assets/png/eyeInvisible-821d9d16.png"; // 👁️ Replace with hidden eye icon
                }
            });
        });
    });

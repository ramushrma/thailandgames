       ...
       <div class="row column1">
             ...
             <div class="full counter_section margin_bottom_">
                ...
                <div class="counter_no">
                   <div>
					   ...
					   <p class="total_no">{{$users[0]->totaluser}}</p>
                      <p class="head_couter">Total Player</p>
                   </div>
                </div>
             </div>
             ...
             <div class="full counter_section margin_bottom_">
                ...
                <div class="counter_no">
                   <div>
					   ...
					   <p class="total_no">{{$users[0]->activeuser}}</p>
          ...
          <div class="col-md-6 col-lg-3">
             <div class="full counter_section margin_bottom_30">
                ...
                <div class="counter_no">
                   <div>
                      <p class="total_no"> ₹ {{$users[0]->total_turnover}}</p>
          ...
          <div class="col-md-6 col-lg-3">
             <div class="full counter_section margin_bottom_30">
                ...
                <div class="counter_no">
                   <div>
					   <p class="total_no"> ₹ {{$users[0]->todayturnover}}</p>
       ...
       <div class="row column1">
         <div class="col-md-6 col-lg-3">
            <div class="full counter_section margin_bottom_30">
               ...
               <div class="counter_no">
                  <div>
                     <p class="total_no"> ₹ {{$users[0]->commissions}}</p>
         ...
         <div class="col-md-6 col-lg-3">
            <div class="full counter_section margin_bottom_30">
               ...
               <div class="counter_no">
                  <div>
                     <p class="total_no"> ₹ {{$users[0]->totaldeposit}}</p>
                      <p class="head_couter">Total Deposit</p>
                  </div>
               </div>
            </div>
         ...
         <div class="col-md-6 col-lg-3">
            <div class="full counter_section margin_bottom_30">
               ...
               <div class="counter_no">
                  <div>
					   <p class="total_no"> ₹ {{$users[0]->tdeposit}}</p>
                     <p class="head_couter">Today Deposit</p>
         ...
         <div class="col-md-6 col-lg-3">
            <div class="full counter_section margin_bottom_30">
               ...
               <div class="counter_no">
                  <div>
					    <p class="total_no"> ₹ {{$users[0]->totalwithdraw}}</p>
      ...
      <div class="row column1">
		  <div class="col-md-6 col-lg-3">
            <div class="full counter_section margin_bottom_30">
               ...
               <div class="counter_no">
                  <div>
                       <p class="total_no"> ₹ {{$users[0]->tamount}}</p>
         ...
         <div class="col-md-6 col-lg-3">
            <div class="full counter_section margin_bottom_30">
               ...
               <div class="counter_no">
                  <div>
                     <p class="total_no">{{$users[0]->totalfeedback}}</p>
                     <p class="head_couter">FeedBack</p>
                  </div>
               </div>
            </div>
		   ...
		   <div class="col-md-6 col-lg-3">
             <div class="full counter_section margin_bottom_30">
                ...
                <div class="counter_no">
                   <div>
                      <p class="total_no">{{$users[0]->totalgames}}</p>
                      <p class="head_couter">Total Games</p>
                   </div>
                </div>
             </div>
